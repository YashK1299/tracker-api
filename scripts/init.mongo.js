/*
 * Run using tje mongo shell. For remote databases, ensure that the
 * connection string is supplied in the command line. For example:
 * localhost:
 *   mongo issuetracker scripts/init.mongo.js
 * Atlas:
 *   mongo mongodb+srv://yashk:mongo123@cluster0.1myel.mongodb.net/issuetracker scripts/init.mongo.js
 * MLab:
